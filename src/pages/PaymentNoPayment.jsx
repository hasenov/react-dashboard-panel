					...
					<div className="mb-8 shrink-0 grow-0 basis-full px-[15px] sm:max-w-[75%] sm:basis-9/12 sm:max-md:mx-auto md:max-w-[33.333333%] md:basis-1/3">
						...
						<div className="relative overflow-hidden">
							...
							<div className="relative rounded-[7px] bg-dark-gunmetal/75 backdrop-blur-[27.5px]">
								...
								<div className="space-y-[6.5px] bg-chinese-black/25 py-[37px] px-[10.5px]">
									<div className="flex items-start">
										<img src={info} alt="alt" className="mr-3 mt-0.5 w-5 shrink-0" />
										<div className="text-sm font-normal leading-tighter">Ваш тариф будет изменен без оплаты, в счёт оставшихся дней тарифа</div>
									</div>
								</div>
								<div className="py-[13px] pb-[17px] text-center">
									<div className="mb-3 text-xl leading-tighter">Без оплаты</div>
...
export default PaymentNoPayment;
